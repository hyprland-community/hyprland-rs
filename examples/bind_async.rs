...
async fn main() -> hyprland::Result<()> {
    ...
    Keyword::set_async(instance1, "submap", "example").await?;
    ...
    Keyword::set_async(instance1, "submap", "reset").await?;

    let instance2 = Instance::from_instance("long instance name".to_string())?;
    Keyword::set_async(&instance2, "submap", "example2").await?;
    ...
    Keyword::set_async(&instance2, "submap", "reset2").await?;
